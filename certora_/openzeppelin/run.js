...
// USAGE:
//    node certora/openzeppelin/run.js [[CONTRACT_NAME:]SPEC_NAME]* [--all] [--options OPTIONS...] [--specs PATH]
// EXAMPLES:
//    node certora/openzeppelin/run.js --all
//    node certora/openzeppelin/run.js AccessControl
//    node certora/openzeppelin/run.js AccessControlHarness:AccessControl
...
async function runCertora(spec, contract, files, options = []) {
  const args = [...files, '--verify', `${contract}:certora/openzeppelin/specs/${spec}.spec`, ...options];
